...
public enum SendPacketOpcode implements WritableIntValueHolder {
    ...
    SHOW_MAGNIFYING_EFFECT((short) 0x16F),//14c
    SHOW_POTENTIAL_RESET((short) 0x170),//14d
    SHOW_FIREWORKS_EFFECT((short) 0x171),//14e
    SHOW_NEBULITE_EFFECT((short) 0x172),//14f
    SHOW_FUSION_EFFECT((short) 0x173),//150
