...
public class ChannelServer {
    ...
    public final void run_startup_configurations(Properties p) {
    ...
    public static void startChannel_Main(Properties p) {
        System.out.println("Loading Channels...");
        serverStartTime = System.currentTimeMillis();

        for (int i = 0; i < ServerConfig.channelCount; i++) {
            newInstance(i + 1).run_startup_configurations(p);
        }
    }
