...
//        }
    ...
    public static void addCharStats(MaplePacketLittleEndianWriter mplew, MapleCharacter chr) {
      ...
      //  mplew.writeLong((getTime(System.currentTimeMillis())));//v145
...
public static void addCharacterInfo(MaplePacketLittleEndianWriter mplew, MapleCharacter chr) {                
        long mask = -9007199254740993L; // FF FF FF FF FF FF DF FF v146
        ...
        //if (GameConstants.isBeastTamer(chr.getJob())) { //D/C on login. Hex strings for ears/tail, no access to proper packets. Hex is other version (v148?)
